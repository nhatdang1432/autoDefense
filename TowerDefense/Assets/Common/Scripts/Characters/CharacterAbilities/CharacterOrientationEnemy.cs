...
namespace MoreMountains.TopDownEngine
{
    ...
    [AddComponentMenu("TopDown Engine/Character/Abilities/CharacterOrientationEnemy")]
    public class CharacterOrientationEnemy : CharacterAbility
    {
        /// the possible rotation modes
		public enum RotationModes { None, WeaponDirection, Both }
        ...
        protected virtual void RotateToFaceMovementDirection()
        {
            ...
            if ( (RotationMode != RotationModes.Both)) { return; }
