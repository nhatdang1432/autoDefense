...
namespace MoreMountains.TopDownEngine
{
    ...
    /// </summary>
    [AddComponentMenu("TopDown Engine/Character/AI/Decisions/AIDistanceToMissionKillBoss")]
    public class AIDistanceToMissionKillBoss : AIDecision
    {
        ...
        {
            //Debug.Log(_brain.TargetPosition.position);
            if (_brain.TargetPosition == null)
            {
                return false;
            }

            float distance = Vector3.Distance(this.transform.position, _brain.TargetPosition.position);
