...
namespace MoreMountains.TopDownEngine
{
    ...
    /// </summary>
    [AddComponentMenu("TopDown Engine/Character/AI/Decisions/AIDecisionTankerAlly")]
    public class AIDecisionTankerAlly : AIDecision
    {
        ...
        protected virtual bool DetectTarget()
        {
            ...
            //_brain.Target = _brain.TargetPosition;
