...
namespace MoreMountains.TopDownEngine
{
    ...
    /// </summary>
    [AddComponentMenu("TopDown Engine/Character/AI/Actions/AIActionShootEnemy")]
    [RequireComponent(typeof(CharacterOrientationEnemy))]
    [RequireComponent(typeof(CharacterHandleWeapon))]
    public class AIActionShootEnemy : AIAction
    {
        ...
        protected CharacterOrientationEnemy _orientation3D;
        ...
        public override void Initialization()
        {
            ...
            _orientation3D = _character?.FindAbility<CharacterOrientationEnemy>();
        ...
        public override void OnEnterState()
        {
            ...
            {
                handleWeapon.ChangeWeapon(gun, gun.WeaponName, false);
            }
            _numberOfShoots = 0;
            _shooting = true;
            _weaponAim = TargetHandleWeaponAbility.CurrentWeapon.gameObject.MMGetComponentNoAlloc<WeaponAim>();
