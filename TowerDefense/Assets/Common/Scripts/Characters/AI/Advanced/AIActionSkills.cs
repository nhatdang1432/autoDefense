...
namespace MoreMountains.TopDownEngine
{
    ...
    /// </summary>
    [AddComponentMenu("TopDown Engine/Character/AI/Actions/AIActionSkills")]
    ...
    public class AIActionSkills : AIAction
    {
        ...
        public CharacterSkill TargetHandleWeaponAbility;
        ...
        public override void Initialization()
        {
            ...
            {
                TargetHandleWeaponAbility = _character?.FindAbility<CharacterSkill>();
            }
        }
        ...
        {
            _brain.TimeInSkill = 0f;
            _brain.Skillready = false;
        }
        /// <summary>
        ...
        public override void OnEnterState()
        {
            ...
            {
                handleWeapon.ChangeWeapon(Skill, Skill.WeaponName, false);
            }
            _numberOfShoots = 0;
            _shooting = true;
            _weaponAim = TargetHandleWeaponAbility.CurrentWeapon.gameObject.MMGetComponentNoAlloc<WeaponAim>();
