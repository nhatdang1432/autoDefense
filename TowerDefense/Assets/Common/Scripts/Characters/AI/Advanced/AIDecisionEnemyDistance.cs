...
namespace MoreMountains.TopDownEngine
{
    ...
    /// </summary>
    [AddComponentMenu("TopDown Engine/Character/AI/Decisions/AIDecisionEnemyDistance")]
    public class AIDecisionEnemyDistance : AIDecision
    {
        ...
        protected virtual bool EvaluateDistance()
        {
            ...
            {
                return (distance < _brain.Distance);
            }
