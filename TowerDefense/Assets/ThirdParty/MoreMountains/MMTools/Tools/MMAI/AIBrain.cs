...
namespace MoreMountains.Tools
{
    ...
    public class AIBrain : MonoBehaviour
    {
        ...
        public float TimeInSkill = 4f;
        public float TimeInStateDefense = 0f;
        /// the current target
        [MMReadOnly]
        ...
        protected virtual void Update()
        {
            ...
            TimeInSkill += Time.deltaTime;
            if (TimeInSkill > 5f) Skillready = true;
            if (Defense == true && CurrentState.StateName.ToString() == "LineUpDefense")
            {
                TimeInStateDefense += Time.deltaTime;
            }
            else
            {
                TimeInStateDefense = 0f;
            }
